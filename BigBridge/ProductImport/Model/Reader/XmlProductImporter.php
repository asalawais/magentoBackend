...
class XmlProductImporter
{
     ...
     * @param ProductImportWebApiLogger $output
     */
    public function import(string $xmlPath, ImportConfig $config, bool $skipXsdValidation, ProductImportWebApiLogger $output)
    {
        $time = date('H:i:s');
