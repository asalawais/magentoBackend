...
namespace BigBridge\ProductImport\Model\Afas;
...
class Import
{
    ...
    public function runImport($order){
        ...
        $OrderData = [];
            try {
                ...
                foreach ($OrderData['Objects']['Element'] as $sourceKey => $items) {
                    ...
                    if($packingSlipResult['results']['FbDeliveryNote']['OrNu']!=null) {
                ...
                if ($orderN->getId() && !empty($afasOrder)) {
                    ...
                    $orderN->setData('afas_import_status', 1);
