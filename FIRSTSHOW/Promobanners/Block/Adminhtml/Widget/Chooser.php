 ...
 */
namespace FIRSTSHOW\Promobanners\Block\Adminhtml\Widget;
...
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
	...
	public function getModel(){
		return $this->_objectManager->create('FIRSTSHOW\Promobanners\Model\Promobanners');
	}
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn(
            ...
            [
                'header' => __('Preview'),
                'index' => 'filename',
                'renderer' => 'FIRSTSHOW\Promobanners\Block\Adminhtml\Grid\Renderer\Preview',
				'filter'   => false,
				'sortable' => false
            ]
        );
