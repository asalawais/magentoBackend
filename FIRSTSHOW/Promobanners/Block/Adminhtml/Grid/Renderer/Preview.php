 ...
 *
 */
namespace FIRSTSHOW\Promobanners\Block\Adminhtml\Grid\Renderer;
...
class Preview extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    {
		/* $html = $this->getLayout()->createBlock('FIRSTSHOW\Promobanners\Block\Promobanners')->setBannerId($row->getId())->setTemplate('banner.phtml')->toHtml();
		return $html; */
