...
class Edit extends \FIRSTSHOW\Promobanners\Controller\Adminhtml\Promobanners
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $this->_initAction()->_addBreadcrumb(
            ...
            $this->_view->getLayout()->createBlock('FIRSTSHOW\Promobanners\Block\Adminhtml\Edit')
        );
