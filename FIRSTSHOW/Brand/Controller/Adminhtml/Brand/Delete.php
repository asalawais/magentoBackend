...
class Delete extends \Magento\Backend\App\Action
{
    public function execute()
    {
        ...
        if ($id) {
            try {
                ...
                $optionManagement->delete(\Magento\Catalog\Model\Product::ENTITY, 'firstshow_brand', $model->getOptionId());
                $model->delete();
    ...
    {
        return $this->_authorization->isAllowed('FIRSTSHOW_Brand::delete_brand');
    }
}
