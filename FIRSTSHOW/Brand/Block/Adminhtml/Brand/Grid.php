...
namespace FIRSTSHOW\Brand\Block\Adminhtml\Brand;

use FIRSTSHOW\Brand\Model\System\Config\Status;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \FIRSTSHOW\Brand\Model\Resource\Brand\Grid\CollectionFactory $collectionFactory,
        array $data = []
    )
    {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'small_image',
                'renderer' => '\FIRSTSHOW\Brand\Block\Adminhtml\Brand\Grid\Renderer\Image',
                'sortable' => false,
                'filter' => false
            ]
        );
