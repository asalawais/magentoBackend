...
namespace FIRSTSHOW\Brand\Block\Adminhtml\Brand\Edit\Tab;
...
class Product extends Extended
{
    ...
    public function __construct(
        ...
        \FIRSTSHOW\Brand\Model\Resource\Product\CollectionFactory $productCollectionFactory,
        \Magento\Catalog\Model\Product\Attribute\Source\Status $status,
        \Magento\Catalog\Model\Product\Visibility $visibility,
        \Magento\Framework\Registry $coreRegistry,
        \FIRSTSHOW\Brand\Model\Brand $brandFactory,
        array $data = []
    )
    {
