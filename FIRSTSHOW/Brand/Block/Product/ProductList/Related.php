...
namespace FIRSTSHOW\Brand\Block\Product\ProductList;
    ...
    \Magento\Framework\DataObject\IdentityInterface
{
    ...
    protected function _getProductCollection()
    {
        ...
        if ($brand) {
            ...
            $pCollection = $objectManager->create('FIRSTSHOW\Brand\Model\Product')->getCollection();
    ...
    {
        $optionId = $this->getProduct()->getFirstshowBrand();
        if ($optionId) {
