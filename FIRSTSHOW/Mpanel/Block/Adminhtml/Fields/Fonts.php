 ...
 */
namespace FIRSTSHOW\Mpanel\Block\Adminhtml\Fields;
...
class Fonts extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $el = str_replace('firstshowtheme_fonts_', '', $htmlId);
        if ($el == 'h1' || $el == 'h2' || $el == 'h3' || $el == 'h4' || $el == 'h5' || $el == 'h6') {
            ...
            if ($el == 'price') {
                ...
                if ($el == 'menu') {
					...
					if ($el == 'btn') {
						$output .= '<button id="' . $htmlId . '_view" style="font-size:16px; display:block; padding:7px 15px; margin:0">BUTTON</div>';
					} else {
