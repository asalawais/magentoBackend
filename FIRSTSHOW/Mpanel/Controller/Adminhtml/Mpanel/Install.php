...
class Install extends \FIRSTSHOW\Mpanel\Controller\Adminhtml\Mpanel
{
	/**
    ...
    public function execute()
    {
        if($theme = $this->getRequest()->getParam('theme')){
			$dir = $this->_filesystem->getDirectoryRead(DirectoryList::APP)->getAbsolutePath('code/FIRSTSHOW/Mpanel/data/themes/'.$theme);
	...
	public function _importSetting($parsedArray){
		...
		$this->imporSetting($parsedArray, 'theme_setting', 'firstshowtheme');
