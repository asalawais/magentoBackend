...
class Edit extends \FIRSTSHOW\Mpanel\Controller\Adminhtml\Mpanel
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('mpanel_mpanel', $model);
        ...
        $this->_initAction()->_addBreadcrumb(
            ...
            $this->_view->getLayout()->createBlock('FIRSTSHOW\Mpanel\Block\Adminhtml\Edit')
        );
