...
namespace FIRSTSHOW\Blog\Block\Adminhtml\Comment;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \FIRSTSHOW\Blog\Model\Comment $comment,
        \FIRSTSHOW\Blog\Model\Resource\Comment\Grid\CollectionFactory $collectionFactory,
        array $data = []
    )
    {
