...
namespace FIRSTSHOW\Blog\Model;

use Magento\Framework\Model\AbstractModel;
use Magento\Framework\Model\Context;
use Magento\Framework\Registry;
use Magento\Store\Model\StoreManagerInterface;
use FIRSTSHOW\Blog\Model\Resource\Post as PostResource;
use FIRSTSHOW\Blog\Model\Resource\Post\Collection;
use FIRSTSHOW\Blog\Helper\Data;
use Magento\Framework\UrlInterface;
use FIRSTSHOW\Blog\Model\Category;
use FIRSTSHOW\Blog\Model\Comment;
...
class Post extends AbstractModel
{
    ...
    {
        parent::_construct();
        $this->_init('FIRSTSHOW\Blog\Model\Resource\Post');
    }
