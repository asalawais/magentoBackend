...
class Stores extends \Magento\Framework\View\Element\Template
{
    ...
    public function _prepareLayout()
    {
		...
		$breadcrumbsBlock->addCrumb('storelocator_list', ['label' => $title, 'title' => $title]);
     ...
     *
     * @param FIRSTSHOW_Storelocator_Model_Store $storelocator
     * @return int
     */
     ...
     *
     * @param FIRSTSHOW_Storelocator_Model_Storelocator $storelocator
     * @return int
     */
