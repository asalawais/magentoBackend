...
class Editcategory extends \FIRSTSHOW\Portfolio\Controller\Adminhtml\Portfolio
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $this->_initAction()->_addBreadcrumb(
            ...
            $this->_view->getLayout()->createBlock('FIRSTSHOW\Portfolio\Block\Adminhtml\Editcategory')
        );
