...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'emesa_market_category_id',
            [
                'header' => __('Market Category'),
                'index' => 'emesa_market_category_id',
                'class' => 'xxx'
            ]
        );
        ...
        $this->addColumn(
            'send_category_id',
            [
                'header' => __('Export Market Category ID'),
                'type' => 'action',
                'getter' => 'getId',
                'actions' => [
                    [
                        'caption' => __('Export Cat ID'),
                        'url' => [
                            'base' => '*/*/marketcategory',
                            'params' => ['market_category_id' => 'send', 'store' => $this->getRequest()->getParam('store')]
                        ],
                        'field' => 'id'
                    ]
                ],
        ...
        $this->addColumn(
            'send_product_id',
            [
                'header' => __('Export Product'),
                'type' => 'action',
                'getter' => 'getId',
                'actions' => [
                    [
                        'caption' => __('Export Product'),
                        'url' => [
                            'base' => '*/*/exportproduct',
                            'params' => ['store' => $this->getRequest()->getParam('store')]
                        ],
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('exportproducts', [
            'label'=> __('Export Products'),
            'url'  => $this->getUrl('*/*/exportproduct', ['store'=>$this->getRequest()->getParam('store')]),
            'confirm' => __('Are you sure?')
        ]);
        return $this;
    }
