...
class Order {
    ...
    public function importOrder($data, $storeId)
    {
        ...
        try {
            ...
            $this->generalHelper->addTolog('importOrder: ' . $data['wp_id'], $shippingMethod);
           ...
           /* if ($this->lvb && $this->orderHelper->getLvbSkipStock($store->getId())) {
            ...
            if ($this->orderHelper->getUseChannelOrderId($storeId)) {
                $newIncrementId = $this->orderHelper->getUniqueIncrementId($data['wp_id'], $storeId);
            ...
            $this->generalHelper->addTolog('importOrder: ' . $data['wp_id'], $e->getMessage());
            return $this->jsonRepsonse($e->getMessage(), '', $data['wp_id']);
        } finally {
