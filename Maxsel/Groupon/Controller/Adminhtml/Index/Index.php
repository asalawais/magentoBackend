...
class Index implements HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Maxsel_Groupon::index_index');
        $resultPage->getConfig()->getTitle()->prepend(__('Groupon Sync'));
        return $resultPage;
    }
    protected function _isAllowed()
    {
        return $this->_authorization->isAllowed('Maxsel_Groupon::index_index');
    }
}
