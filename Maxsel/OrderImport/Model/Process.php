...
class Process
{
    ...
    public function orderProcess($orderDataN){
        ...
        try {
            ...
            elseif ($storeId==9){
                $channelName = 'nielsslaapcomfort';
                $channelLabel = 'nielsslaapcomfort';
                $shippingPrice = 0.00;
            }
            elseif ($storeId==10){
                $channelName = 'zittenenliggen';
                $channelLabel = 'zittenenliggen';
                $shippingPrice = 0.00;
            }
            if (count($ordRef) === 0) {
                $tempOrder = [
                ...
                //$this->logger->info(print_r($tempOrder, true));
                ...
                $this->logger->info('referenceOrder: '. $orderDataN[0]. ' already exist');
