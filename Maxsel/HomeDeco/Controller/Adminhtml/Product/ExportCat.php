...
namespace Maxsel\HomeDeco\Controller\Adminhtml\Product;
...
class ExportCat implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        try {
            ...
            $fp = fopen('/var/www/html/magento/homeshopping24-2/market_categories.csv', 'w');
